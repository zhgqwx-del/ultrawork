...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "agents.description": "Manage ACP-compatible coding agents (Qoder, Claude Code, etc.)",
    "agents.addAgent": "Add Agent",
    "agents.editAgent": "Edit Agent",
    "agents.noAgents": "No external agents configured",
    "agents.deleteSuccess": "Agent removed",
    "agents.deleteFailed": "Failed to remove agent",
    "agents.connectSuccess": "Agent connected",
    "agents.connectFailed": "Failed to connect agent",
    "agents.saveSuccess": "Agent saved",
    "agents.saveFailed": "Failed to save agent",
    "agents.statusConnected": "Connected",
    "agents.statusConnecting": "Connecting...",
    "agents.statusError": "Error",
    "agents.statusDisconnected": "Disconnected",
    "agents.fieldId": "ID",
    "agents.fieldLabel": "Display Name",
    "agents.fieldDescription": "Description",
    "agents.fieldDescriptionPlaceholder": "A brief description of this agent",
    "agents.fieldCommand": "Command",
    "agents.fieldArgs": "Arguments",
    "agents.fieldArgsHint": "Space-separated arguments (e.g. --acp)",
    "agents.fieldEnv": "Environment Variables",
    "agents.fieldEnvHint": "One per line: KEY=VALUE",
  ...
  zh: {
    ...
    "agents.description": "管理 ACP 兼容的编码 Agent（Qoder、Claude Code 等）",
    "agents.addAgent": "添加 Agent",
    "agents.editAgent": "编辑 Agent",
    "agents.noAgents": "暂无外部 Agent",
    "agents.deleteSuccess": "Agent 已移除",
    "agents.deleteFailed": "移除 Agent 失败",
    "agents.connectSuccess": "Agent 已连接",
    "agents.connectFailed": "连接 Agent 失败",
    "agents.saveSuccess": "Agent 已保存",
    "agents.saveFailed": "保存 Agent 失败",
    "agents.statusConnected": "已连接",
    "agents.statusConnecting": "连接中...",
    "agents.statusError": "错误",
    "agents.statusDisconnected": "未连接",
    "agents.fieldId": "标识符",
    "agents.fieldLabel": "显示名称",
    "agents.fieldDescription": "描述",
    "agents.fieldDescriptionPlaceholder": "对该 Agent 的简短描述",
    "agents.fieldCommand": "启动命令",
    "agents.fieldArgs": "参数",
    "agents.fieldArgsHint": "空格分隔（如 --acp）",
    "agents.fieldEnv": "环境变量",
    "agents.fieldEnvHint": "每行一个：KEY=VALUE",
    "agents.cancel": "取消",
    "agents.save": "保存",
    "agents.add": "添加",
