...
import { SidebarProvider, LeftSidebar, useSidebar } from "@/components/layout"
...
function SessionContent() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[--sidebar-bg]">
      ...
      {/* Main Content */}
      <div className="my-2 mr-2 flex min-w-0 flex-1 overflow-hidden rounded-2xl bg-[--color-bg] shadow-sm">
        {/* Left Panel - Chat */}
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden rounded-2xl">
          ...
          <header className="z-10 flex shrink-0 items-center gap-2 border-none px-4 py-3">
            <button
              onClick={toggleLeft}
              className="flex cursor-pointer items-center justify-center rounded-lg p-2 text-[--color-fg-muted] transition-colors hover:bg-[--color-accent] hover:text-[--color-fg] md:hidden"
            >
          ...
          {/* Messages Area */}
          <div className={cn("relative flex-1 overflow-x-hidden overflow-y-auto", "flex justify-center")}>
            ...
            <div className="w-full max-w-[800px] px-4 py-3">
              ...
              <div className="rounded-xl border border-[--color-border] bg-[--color-bg] p-3 shadow-sm">
                ...
                <div className="mt-2 flex items-center justify-end">
                  <button className="flex size-7 cursor-pointer items-center justify-center rounded-full bg-[--color-fg-muted] text-[--color-bg]">
