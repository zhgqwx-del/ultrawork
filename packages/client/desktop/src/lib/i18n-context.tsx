...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "model.customProvider.scopeHint": "Saved to the current workspace.",
    "model.customProvider.noWorkspace": "Open a workspace first to add a custom provider.",
  ...
  zh: {
    ...
    "model.customProvider.scopeHint": "保存到当前工作区。",
    "model.customProvider.noWorkspace": "请先打开一个工作区，再添加自定义供应商。",
