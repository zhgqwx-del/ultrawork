...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "cliConnector.configHint": "Creates/binds a Feishu app via a hosted page — no manual App ID needed.",
    "cliConnector.authHint": "Authorizes the agent to act on your Feishu data via OAuth device flow.",
  ...
  zh: {
    ...
    "cliConnector.configHint": "通过飞书托管页自动创建/绑定应用，无需手动填 App ID。",
    "cliConnector.authHint": "通过 OAuth 设备流授权 Agent 以你的身份访问飞书数据。",
