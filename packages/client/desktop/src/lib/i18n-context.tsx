...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.orchestrate.title": "Orchestrate mode (OpenCode chats)",
    "settings.orchestrate.desc": "Give OpenCode main chats a delegate tool to hand subtasks to other agents",
    "settings.orchestrate.restartNote": "Will fully apply after the app restarts",
  ...
  zh: {
    ...
    "settings.orchestrate.title": "编排模式（OpenCode 对话）",
    "settings.orchestrate.desc": "为 OpenCode 主对话注入 delegate 工具，可把子任务委派给其它 agent",
    "settings.orchestrate.restartNote": "重启应用后完全生效",
