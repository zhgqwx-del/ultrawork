...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "services.title": "MCP Connectors",
    "services.description": "Manage MCP connectors that link external tools and data sources to extend agent capabilities.",
  ...
  zh: {
    ...
    "services.title": "MCP 连接器",
    "services.description": "管理 MCP 连接器，连接外部工具与数据源，扩展 Agent 的能力。",
