...
| **S3** 🟡 | `xlsx` 技能（含 office 底座首次实现）。**三刀已落**：office 底座 + X1/X2/X15，公式族 X3/X5/X10，结构性写入 X6-X9，**5 项 pending**（见 §六·补二） | xlsx/ + office 底座 | **新窗口** |
...
然后 X11/X12/X13/X14 收官，`--no-pending xlsx` 转绿则 S3 完成。
