...
| [019-pipeline-surface-form.md](./019-pipeline-surface-form.md) | 流水线 UI 收纳与形态 — 编排 surface 的「另一半」（伞名「自动化」+页内「流水线·Fan-out」/ footer 二级入口微调 / agent-avatar 视觉对齐 / 页内自我说明；功能零改动，承接 018 Q2 拍板） | 2026-06-13 | ✅ 已拍板待开工 |
